...
function recuperarContactos() {
  console.log('recuperarContactos')
  const contactos = localStorage.getItem('contactos')
  return contactos ? JSON.parse(contactos) : []
}

function usePersistedState(key) {
  const [valor, setValor] = useState(recuperarContactos)
...
function App() {
  ...
  const [contactos, setContactos] = usePersistedState('contactos')  
  ...
  useEffect(() => { console.log("cambio") }, [contactos])
